...
import { FaUserCircle, FaArrowLeft, FaSearch, FaSortAmountDown, FaGraduationCap, 
  FaChalkboardTeacher, FaHome, FaUserGraduate, FaChartLine, FaClipboardList, 
  FaCalendarAlt, FaVideo, FaBars, FaSignOutAlt, FaArrowRight } from 'react-icons/fa';
