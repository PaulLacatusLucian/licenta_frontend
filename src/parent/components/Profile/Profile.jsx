    ...
    const fetchAllData = async () => {
      try {
        ...
        const [parentResponse, childResponse, teachersResponse, absencesResponse, gradesResponse] = await Promise.all([
          axios.get('/parents/me'), // Assuming this endpoint exists or can be created
        ...
        console.log('Parent data response:', parentResponse.data);
        console.log('Child data response:', childResponse.data);
              ...
              <div className="md:col-span-1">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 mt-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <button 
                      className="w-full bg-light text-dark py-3 px-4 rounded-lg flex items-center justify-between hover:bg-gray-200 transition-all"
                    >
                      <span className="flex items-center">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      {teachers.map((teacher, index) => (
                        <div key={index} className="flex items-center p-4 border rounded-lg">
                          ...
                          <button className="ml-2 bg-light hover:bg-gray-200 p-2 rounded-full">
